...
* [Conversion Programs](https://github.com/sergio-a-juarez-1/Python-Projects/tree/main/Conversion_Program) - An optimized, graphical user interface (GUI) application built with Python and Tkinter that combines four conversion utilities into a single, robust desktop tool.
