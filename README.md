...
* [GAME: Turtle Crossing](https://github.com/sergio-a-juarez-1/Python-Projects/tree/main/Snake) - A lightweight, hardware-accelerated arcade crossing game built in pure C. This clone of the popular Python "Turtle Crossing" game replaces heavy scripts with low-level Linux graphics layers, rendering shapes directly via hardware acceleration.
